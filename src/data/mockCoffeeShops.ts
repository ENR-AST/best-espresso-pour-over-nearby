...
export const mockCoffeeShops: CoffeeShop[] = [
  ...
  },
  {
    ...
    streetAddress: "1026 Valencia St",
    neighborhood: "Mission District",
    city: "San Francisco",
    state: "CA",
    zipCode: "94110",
